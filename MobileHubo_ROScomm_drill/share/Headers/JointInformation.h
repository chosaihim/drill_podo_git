...
enum JointMobileNumber
{
    mRSP, mRSR, mRSY, mREB, mRWY, mRWP, mRWY2,
    mLSP, mLSR, mLSY, mLEB, mLWY, mLWP, mLWY2,
    mWST,
    mRHAND, mLHAND,
    mRWH, mLWH, mBWH, NO_OF_MOBILE_JOINTS
};
...
const QString JointMobileNameList[NO_OF_MOBILE_JOINTS] = {
    "mRSP", "mRSR", "mRSY", "mREB", "mRWY", "mRWP", "mRWY2",
    "mLSP", "mLSR", "mLSY", "mLEB", "mLWY", "mLWP", "mLWY2",
    "mWST",
    "mRHAND", "mLHAND",
