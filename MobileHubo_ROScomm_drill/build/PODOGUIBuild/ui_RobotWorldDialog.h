...
public:
    ...
    QLineEdit *LE_ROBOT_POS_X;
    QLineEdit *LE_ROBOT_POS_Y;
    QLineEdit *LE_ROBOT_POS_YAW;
    QLineEdit *LE_OBJECT_POS_Y;
    QLineEdit *LE_OBJECT_POS_X;
    QLineEdit *LE_OBJECT_POS_Z;
    QLabel *label_5;
    QLabel *label_6;
    QLineEdit *LE_ROBOT_POS_X_SLAM;
    QLabel *label_7;
    QLineEdit *LE_ROBOT_POS_YAW_SLAM;
    QLineEdit *LE_ROBOT_POS_Y_SLAM;
    QPushButton *PB_RESET_ROBOTPOS;
    QPushButton *pushButton;
    QPushButton *pushButton_2;
    QWidget *layoutWidget_2;
    QVBoxLayout *verticalLayout_3;
    QPushButton *PB_SAVE_2;
    QPushButton *PB_SAVE_START_2;
    ...
    void setupUi(QDialog *RobotWorldDialog)
    {
        ...
        layoutWidget1->setGeometry(QRect(650, 30, 101, 91));
        ...
        LE_ROBOT_POS_X = new QLineEdit(RobotWorldDialog);
        LE_ROBOT_POS_X->setObjectName(QStringLiteral("LE_ROBOT_POS_X"));
        LE_ROBOT_POS_X->setGeometry(QRect(30, 450, 71, 22));
        LE_ROBOT_POS_Y = new QLineEdit(RobotWorldDialog);
        LE_ROBOT_POS_Y->setObjectName(QStringLiteral("LE_ROBOT_POS_Y"));
        LE_ROBOT_POS_Y->setGeometry(QRect(110, 450, 71, 22));
        LE_ROBOT_POS_YAW = new QLineEdit(RobotWorldDialog);
        LE_ROBOT_POS_YAW->setObjectName(QStringLiteral("LE_ROBOT_POS_YAW"));
        LE_ROBOT_POS_YAW->setGeometry(QRect(190, 450, 71, 22));
        LE_OBJECT_POS_Y = new QLineEdit(RobotWorldDialog);
        LE_OBJECT_POS_Y->setObjectName(QStringLiteral("LE_OBJECT_POS_Y"));
        LE_OBJECT_POS_Y->setGeometry(QRect(110, 550, 71, 22));
        LE_OBJECT_POS_X = new QLineEdit(RobotWorldDialog);
        LE_OBJECT_POS_X->setObjectName(QStringLiteral("LE_OBJECT_POS_X"));
        LE_OBJECT_POS_X->setGeometry(QRect(30, 550, 71, 22));
        LE_OBJECT_POS_Z = new QLineEdit(RobotWorldDialog);
        LE_OBJECT_POS_Z->setObjectName(QStringLiteral("LE_OBJECT_POS_Z"));
        LE_OBJECT_POS_Z->setGeometry(QRect(190, 550, 71, 22));
        label_5 = new QLabel(RobotWorldDialog);
        label_5->setObjectName(QStringLiteral("label_5"));
        label_5->setGeometry(QRect(40, 430, 59, 14));
        label_6 = new QLabel(RobotWorldDialog);
        label_6->setObjectName(QStringLiteral("label_6"));
        label_6->setGeometry(QRect(40, 530, 71, 16));
        LE_ROBOT_POS_X_SLAM = new QLineEdit(RobotWorldDialog);
        LE_ROBOT_POS_X_SLAM->setObjectName(QStringLiteral("LE_ROBOT_POS_X_SLAM"));
        LE_ROBOT_POS_X_SLAM->setGeometry(QRect(30, 500, 71, 22));
        label_7 = new QLabel(RobotWorldDialog);
        label_7->setObjectName(QStringLiteral("label_7"));
        label_7->setGeometry(QRect(40, 480, 101, 16));
        LE_ROBOT_POS_YAW_SLAM = new QLineEdit(RobotWorldDialog);
        LE_ROBOT_POS_YAW_SLAM->setObjectName(QStringLiteral("LE_ROBOT_POS_YAW_SLAM"));
        LE_ROBOT_POS_YAW_SLAM->setGeometry(QRect(190, 500, 71, 22));
        LE_ROBOT_POS_Y_SLAM = new QLineEdit(RobotWorldDialog);
        LE_ROBOT_POS_Y_SLAM->setObjectName(QStringLiteral("LE_ROBOT_POS_Y_SLAM"));
        LE_ROBOT_POS_Y_SLAM->setGeometry(QRect(110, 500, 71, 22));
        PB_RESET_ROBOTPOS = new QPushButton(RobotWorldDialog);
        PB_RESET_ROBOTPOS->setObjectName(QStringLiteral("PB_RESET_ROBOTPOS"));
        PB_RESET_ROBOTPOS->setGeometry(QRect(270, 450, 121, 51));
        pushButton = new QPushButton(RobotWorldDialog);
        pushButton->setObjectName(QStringLiteral("pushButton"));
        pushButton->setGeometry(QRect(660, 180, 80, 22));
        pushButton_2 = new QPushButton(RobotWorldDialog);
        pushButton_2->setObjectName(QStringLiteral("pushButton_2"));
        pushButton_2->setGeometry(QRect(660, 210, 80, 22));
        layoutWidget_2 = new QWidget(RobotWorldDialog);
        layoutWidget_2->setObjectName(QStringLiteral("layoutWidget_2"));
        layoutWidget_2->setGeometry(QRect(550, 30, 91, 91));
        verticalLayout_3 = new QVBoxLayout(layoutWidget_2);
        verticalLayout_3->setObjectName(QStringLiteral("verticalLayout_3"));
        verticalLayout_3->setContentsMargins(0, 0, 0, 0);
        PB_SAVE_2 = new QPushButton(layoutWidget_2);
        PB_SAVE_2->setObjectName(QStringLiteral("PB_SAVE_2"));

        verticalLayout_3->addWidget(PB_SAVE_2);

        PB_SAVE_START_2 = new QPushButton(layoutWidget_2);
        PB_SAVE_START_2->setObjectName(QStringLiteral("PB_SAVE_START_2"));

        verticalLayout_3->addWidget(PB_SAVE_START_2);
    ...
    void retranslateUi(QDialog *RobotWorldDialog)
    {
        ...
        PB_WHEEL_MOVE_FRONT->setText(QApplication::translate("RobotWorldDialog", "Go2Display", 0));
        PB_WHEEL_MOVE_BACK->setText(QApplication::translate("RobotWorldDialog", "Go2Home", 0));
        RB_WST_180->setText(QApplication::translate("RobotWorldDialog", "WST180Rotation", 0));
        label_5->setText(QApplication::translate("RobotWorldDialog", "RobotPos", 0));
        label_6->setText(QApplication::translate("RobotWorldDialog", "ObjectPos", 0));
        label_7->setText(QApplication::translate("RobotWorldDialog", "RobotSLAMPos", 0));
        PB_RESET_ROBOTPOS->setText(QApplication::translate("RobotWorldDialog", "ResetRobotPos", 0));
        pushButton->setText(QApplication::translate("RobotWorldDialog", "test", 0));
        pushButton_2->setText(QApplication::translate("RobotWorldDialog", "test(put)", 0));
        PB_SAVE_2->setText(QApplication::translate("RobotWorldDialog", "Save", 0));
        PB_SAVE_START_2->setText(QApplication::translate("RobotWorldDialog", "DataSaveStart", 0));
    } // retranslateUi
