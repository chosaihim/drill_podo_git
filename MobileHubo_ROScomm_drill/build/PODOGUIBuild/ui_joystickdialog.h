...
public:
    ...
    void setupUi(QDialog *JoyStickDialog)
    {
        ...
        PB_ONEHAND_WHEEL = new QPushButton(JoyStickDialog);
        PB_ONEHAND_WHEEL->setObjectName(QStringLiteral("PB_ONEHAND_WHEEL"));
        PB_ONEHAND_WHEEL->setGeometry(QRect(270, 120, 181, 91));
        pushButton = new QPushButton(JoyStickDialog);
        pushButton->setObjectName(QStringLiteral("pushButton"));
        pushButton->setGeometry(QRect(320, 290, 80, 22));
        pushButton_2 = new QPushButton(JoyStickDialog);
        pushButton_2->setObjectName(QStringLiteral("pushButton_2"));
        pushButton_2->setGeometry(QRect(410, 290, 80, 22));
    ...
    void retranslateUi(QDialog *JoyStickDialog)
    {
        ...
        PB_ONEHAND_WHEEL->setText(QApplication::translate("JoyStickDialog", "One Hand with Wheel!!", 0));
        pushButton->setText(QApplication::translate("JoyStickDialog", "display", 0));
        pushButton_2->setText(QApplication::translate("JoyStickDialog", "home", 0));
    } // retranslateUi
