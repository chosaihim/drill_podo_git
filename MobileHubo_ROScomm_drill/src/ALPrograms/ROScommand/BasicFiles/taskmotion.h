...
public:
    explicit TaskMotion(pRBCORE_SHM_REFERENCE _shm_ref, pRBCORE_SHM_SENSOR _shm_sen, pRBCORE_SHM_COMMAND _shm_com, pROS_SHM _shm_ros, JointControlClass *_joint);
    ~TaskMotion();
