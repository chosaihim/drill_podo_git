    ...
    ui(new Ui::RobotWorldDialog)
{
    ...
    AlNumRobotWorld = PODOALDialog::GetALNumFromFileName("RobotWorldManua");
    AlNumRobotWorldros = PODOALDialog::GetALNumFromFileName("RobotWorld");
...
void RobotWorldDialog::on_PB_SAVE_2_clicked()
{
    USER_COMMAND cmd;
    cmd.COMMAND_TARGET = AlNumRobotWorldros;
    cmd.COMMAND_DATA.USER_COMMAND = ROBOTWORLD_AL_SAVE;
    cmd.COMMAND_DATA.USER_PARA_INT[0] = 0;
    pLAN->SendCommand(cmd);
}

void RobotWorldDialog::on_PB_SAVE_START_2_clicked()
{
    USER_COMMAND cmd;
    cmd.COMMAND_TARGET = AlNumRobotWorldros;
    cmd.COMMAND_DATA.USER_COMMAND = ROBOTWORLD_AL_SAVE;
