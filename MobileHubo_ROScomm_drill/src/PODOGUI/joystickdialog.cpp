...
//    AlunumWMupperbody=PODOALDialog::GetALNumFromALName("WMupperbody_AL");
    ...
    AlnumRobotWorldManual = PODOALDialog::GetALNumFromALName("RobotWorldManua");
...
void JoyStickDialog::DisplayUpdate()
{
    ...
    if(ManualModeFlag == true){
        if(ManualModeCount<10){
            ...
            USER_COMMAND cmd;
            cmd.COMMAND_DATA.USER_PARA_CHAR[10] = JOY_LT;
            cmd.COMMAND_DATA.USER_PARA_CHAR[11] = JOY_LB;
            cmd.COMMAND_DATA.USER_PARA_CHAR[12] = JOY_RT;
            cmd.COMMAND_DATA.USER_PARA_CHAR[13] = JOY_RB;

            cmd.COMMAND_DATA.USER_PARA_CHAR[14] = JOY_A;
            cmd.COMMAND_DATA.USER_PARA_CHAR[15] = JOY_B;
            cmd.COMMAND_DATA.USER_PARA_CHAR[16] = JOY_X;
            cmd.COMMAND_DATA.USER_PARA_CHAR[17] = JOY_Y;

            cmd.COMMAND_DATA.USER_PARA_CHAR[18] = JOY_BACK;
            cmd.COMMAND_DATA.USER_PARA_CHAR[19] = JOY_START;

            cmd.COMMAND_DATA.USER_PARA_CHAR[9] = JOY_LOGITECH;

            cmd.COMMAND_DATA.USER_PARA_INT[10] = JOY_LJOG_RL;
            cmd.COMMAND_DATA.USER_PARA_INT[11] = JOY_LJOG_UD;
            cmd.COMMAND_DATA.USER_PARA_INT[12] = JOY_RJOG_RL;
            cmd.COMMAND_DATA.USER_PARA_INT[13] = JOY_RJOG_UD;

            cmd.COMMAND_DATA.USER_PARA_INT[14] = JOY_AROW_RL;
            cmd.COMMAND_DATA.USER_PARA_INT[15] = JOY_AROW_UD;
...
void JoyStickDialog::GetJoystickData(void)
{
    ...
    JOY_LOGITECH = joystick->JoyButton[8];
...
void JoyStickDialog::on_JOY_BTN_START_clicked()
{
    ...
    cmd.COMMAND_DATA.USER_COMMAND = JOYSTICKMODE_START;
    cmd.COMMAND_DATA.USER_PARA_CHAR[0] = 0; //On
    cmd.COMMAND_TARGET = AlnumRobotWorldManual;
    pLAN->SendCommand(cmd);
}
...
void JoyStickDialog::on_MANUAL_BTN_STOP_clicked()
{
    ...
    cmd.COMMAND_DATA.USER_PARA_CHAR[0]=0;
    cmd.COMMAND_DATA.USER_COMMAND = ROBOTWORLD_AL_MANUAL_MODE;
    cmd.COMMAND_TARGET = AlnumRobotWorldManual;
    pLAN->SendCommand(cmd);
    ManualModeFlag = false;
}

void JoyStickDialog::on_PB_ONEHAND_WHEEL_clicked()
{
    ManualModeFlag = 0;
...
void JoyStickDialog::on_pushButton_clicked()
{
    USER_COMMAND cmd;
    cmd.COMMAND_DATA.USER_COMMAND = ROBOTWORLD_AL_MANUAL_MODE;
    cmd.COMMAND_TARGET = AlnumRobotWorld;
...
void JoyStickDialog::on_pushButton_2_clicked()
{
    USER_COMMAND cmd;
